...
from src.repo import BaseRepository, RedisCacheRepository, ImageRepository
from src.database import get_session, base, models as db_models
...
def get_db_repo(
    ...
    def func(session: Annotated[AsyncSession, Depends(get_session)]) -> BaseRepository:
        return repo_class(session, model)
...
def get_image_service(
    image_repository: ImageRepository = Depends(get_db_repo(db_models.Image, ImageRepository)),
